...
export const Following = () => {
  ...
  const getUsers = async (nextPage = 1) => {
    ...
    const request = await fetch(Global.url + "follow/following/" + userIda + "/" + nextPage, {
      method: "GET",
      headers: {
  ...
  return (
    <>
      <header className="content__header">
        <h1 className="content__title">Usuarios que sigue a {userProfile.name} {userProfile.surname} </h1>
      </header>
