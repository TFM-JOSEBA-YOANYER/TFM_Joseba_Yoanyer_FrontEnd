    ...
    <aside className="layout__aside">
            ...
            <div className="aside__container">
                ...
                <div className="aside__container-form">
                 ...
                 { stored == "stored" ? <b className='alert alert-success' >Publicada Correctamente !!</b> : "" } 
             { stored == "error" ? <b className='alert alert-danger' >No se ha publicado Nada!!</b> : "" } 
